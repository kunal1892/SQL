...
# Error Handling:
/*
- MySQL handler to handle errors encountered in stored procedures, functions.
...
- After declaring the ACTION, you need to tell the system what needs to be done for the exception. 
  There are three things that can be done
	1. A MYSQL ERROR CODE (E.G. 1146,1062)
    2. A STANDARD SQLSTATE VALUE OR IT CAN BE SQLWARNING, NOT FOUND, SQLEXCEPTION
